...
export default function Support() {
    ...
    const a6 = "Yes, you can customize your layout and color according to your requirements. In case of any queries, please feel free to contact us at: info@snap-compare.com"
    ...
    const mediaCardDesc = <span>Relax and unwind, we are here to help. Please feel free to contact us at: <br></br><strong>support@snap-compare.com</strong></span>;
                    ...
                    <Layout.Section>
                        ...
                        <MediaCard
                            ...
                            primaryAction={{
                                ...
                                onAction: () => {
                                    console.log('clicked')
                                    window.open('mailto:support@snap-compare.com')
                                },
                            }}
